...
public class ReceiptInItemListAdapter extends BaseAdapter {
    private ArrayList<Beverage> listViewItemList ;

    public ReceiptInItemListAdapter() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ReceiptInItemListAdapter.ViewHolder holder = null;
        ...
        if(convertView == null) {
            ...
            holder = (ReceiptInItemListAdapter.ViewHolder) convertView.getTag();
        }
        ...
        if(item!= null){
            ...
            String str_option= "" + item.getShot_num() + "샷 / " + item.getSize() + " ";
